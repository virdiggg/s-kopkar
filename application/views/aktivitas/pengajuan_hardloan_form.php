      ...
      <div class="card">
      	<div class="card-header">
      		<h3 class="card-title">Hardloan</h3>
                  ...
                  <a href="<?=site_url('aktivitas/tampil_data_pengajuan') ?>" class="btn btn-warning">
                        <i class="fas fa-undo"> Data Pengajuan</i>                      
                  </a>
      	...
      	<div class="card-body">
      		<div class="row">
      			<div class="col-md-4">
      				...
      				<form action="<?=site_url('aktivitas/pengajuan_hardloan_proses')?>" method="post">
