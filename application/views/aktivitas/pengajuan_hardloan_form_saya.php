...
<section class="content">
      <div class="card">
      	<div class="card-header">
      		<h3 class="card-title">Hardloan</h3>
      	...
      	<div class="card-body">
      		<div class="row">
      			<div class="col-md-4">
      				...
      				<form action="<?=site_url('aktivitas/pengajuan_hardloan_proses_saya')?>" method="post">
                             <div class="form-group">
                              ...
                              <div class="form-group input-group">
                                    ...
                                    <input type="text" name="nama" id="nama" value="<?= $this->fungsi->user_login()->nama ?>" class="form-control" required readonly>
                                   
                              </div>
                               <div class="form-group">
                               <label>Koperasi ID</label>
                                    <input type="text" name="koperasi_id" id="koperasi_id" value="<?= $this->fungsi->user_login()->koperasi_id ?>" class="form-control" readonly>
                              </div>
                              <div class="form-group">
                               <label>Jumlah </label>
                               ...
                               <div class="form-group">
                               <label>Status</label>
                                    <input type="text" name="jenis_pinjaman" class="form-control" value="HARDLOAN" readonly>
                                    <input type="hidden" name="status_pengajuan" class="form-control" value="MENUNGGU">
                              </div>
                              <div class="form-group">
                              <label>Lama Angsuran ( max 24 Bulan )</label>
                                    <input type="number" name="lama_angsuran" class="form-control col-md-2">
