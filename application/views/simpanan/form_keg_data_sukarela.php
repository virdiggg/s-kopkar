      		...
      		<div class="row">
      			<div class="col-md-4">
      				...
      				<form action="" method="post">
                              ...
                              <input type="hidden" name="ss_id" class="form-control col-md-2" value="<?=$row->ss_id?>" readonly>                             
                              ...
                              <label>Nama</label>
                               ...
                               <div class="form-group">
                               <label>Status</label>
                                    <input type="text" name="sukarela" class="form-control" value="Sukarela" readonly>
                              </div>
                              <div class="form-group">
                                  <label>Aksi</label>
