      ...
      <div class="card">
      	<div class="card-header">
      		<h3 class="card-title">Tambah Data</h3>
                  ...
                  <a href="<?=site_url('simpanan_sukarela/tampil_data') ?>" class="btn btn-warning">
      	...
      	<div class="card-body">
      		<div class="row">
      			<div class="col-md-4">
      				...
      				<div class="form-group <?= form_error('simpanan_sukarela') ? 'text-danger' : null; ?>">
      					<label>Simpanan sukarela *</label> 
      						<input type="number" name="simpanan_sukarela" value="<?=set_value('simpanan_sukarela'); ?>" class="form-control">
      						<?= form_error('simpanan_sukarela'); ?>
