      	...
      	<div class="card-header">
      		<h3 class="card-title">Simpanan Pokok</h3>
                  <div class="text-right">
                   <div class="text-right">
                  <a target="_blank" href="<?=site_url('simpanan_pokok/simpanan_pokok_print') ?>" class="btn btn-default">
                        <i class="fas fa-print"> Print </i>                      
                  </a>
                   <a href="" class="btn btn-warning">
                        <i class="fas fa-hand-holding-usd"> Total : Rp. <?= number_format($this->fungsi->total_pokok()->jumlah ?? 0, 0) ?> </i>                     
                  </a>
                  <a href="<?=site_url('simpanan_pokok/tambah_data_pokok') ?>" class="btn btn-primary">
      			...
      			<tr>
                             ...
                             <td>
                              <a id="set_dtl" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-detail" 
                                          ...
                                          data-sp_id="<?=$data->sp_id?>">
                                               <i class="fas fa-edit"> Ubah</i>     
                                          </a>
                                <a class="btn btn-info btn-xs" href="<?=site_url('simpanan_pokok/kegiatan_tabungan/'.$data->sp_id) ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Ubah Simpanan Pokok</h4>
          ...
          <div class="row">
            <div class="col-md">
              ...
              <div class="form-group">
                    <label>SP ID</label>            
                    <input type="text" name="sp_id" id="sp_id" class="form-control" readonly>
              </div>
              <div class="form-group">
